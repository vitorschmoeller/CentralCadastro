                    ...
                    ></textarea>
                        ...
                        {customers.length === 0 && (
                            <Link href="/dashboard/customer/new">
                                Você ainda não tem nenhum cliente, <span className="text-blue-500 font-medium">cadastre aqui!</span>
                            </Link>
                        )}

                    <button 
                    type="submit" 
                    className="bg-blue-500 text-white px-2 font-bold h-11 rounded w-full my-4 disabled:cursor-not-allowed disabled:bg-slate-400"
